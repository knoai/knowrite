...
<p align="center">
  ...
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-NC--1.0-orange.svg" alt="License: NC-1.0"></a>
...
用户请求 → POST /api/novel/start 或 /api/novel/continue
    │
    ├─→ 1. 上下文编译：大纲 + 近史全文 + 远史压缩 + 世界观 + RAG 检索 + 反重复提醒
...
**后端**：NC-1.0 (Non-Commercial License)
