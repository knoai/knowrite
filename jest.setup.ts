...
jest.mock('./src/models/index', () => {
  ...
  const Prompt = sequelize.define('Prompt', {
    ...
    content: DataTypes.TEXT,
  }, { tableName: 'prompts', timestamps: true });
  ...
  const Volume = sequelize.define('Volume', {
    ...
    outlineFile: DataTypes.STRING,
    chapterRange: DataTypes.JSON,
    status: DataTypes.STRING,
  }, { tableName: 'volumes', timestamps: false });
  ...
  }, { tableName: 'character_memories', timestamps: true });
  ...
  return {
    ...
    Embedding, Setting, Prompt, Volume, CharacterMemory,
