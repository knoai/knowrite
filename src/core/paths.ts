...
const WORKS_DIR: string = path.join(__dirname, '../../works');
const SAFE_ID_REGEX: RegExp = /^[a-zA-Z0-9_\-\u4e00-\u9fa5]+$/;
...
function sanitizeWorkId(workId: unknown): string | null {
...
function getWorkDir(workId: string): string {
